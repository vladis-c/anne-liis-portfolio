...
export const H1 = ({children, className = ''}: TextProps) => (
  <h1
    className={`font-h text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-white ${className}`}>
    {children}
  </h1>
);
...
export const H2 = ({children, className = ''}: TextProps) => (
  <h2
    className={`font-h text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-white ${className}`}>
    {children}
  </h2>
);
...
export const H3 = ({children, className = ''}: TextProps) => (
  <h3
    className={`font-h text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-white ${className}`}>
    {children}
  </h3>
);
...
export const H4 = ({children, className = ''}: TextProps) => (
  <h4
    className={`font-h text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-white ${className}`}>
    {children}
  </h4>
);
...
export const H5 = ({children, className = ''}: TextProps) => (
  <h5
    className={`font-h text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-white ${className}`}>
    {children}
  </h5>
);
...
export const H6 = ({children, className = ''}: TextProps) => (
  <h6
    className={`font-h text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl text-white ${className}`}>
    {children}
  </h6>
);
...
export const P = ({children, className = ''}: TextProps) => (
  <p
    className={`font-p text-xs sm:text-sm md:text-sm lg:text-base xl:text-base text-white ${className}`}>
    {children}
  </p>
);
